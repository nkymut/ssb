...
theme: gaia
class: invert
# footer: "SoundSpaceBody Studio· Week 01"
# headingDivider: 1
...
![bg left:50% w:60%](./assets/ssb_triadic.png)
...
> To focus on purer sound experience design, art installations, <br>set museums or galleries as a spatial context.
...
> The affordance of anything is <br>**a specific combination of the properties of its substance and its surfaces taken with reference to an animal.** <br>(Gibson 1979)


![bg right:40% h:100% vertical](./assets/img/affordance__16.png)
![bg right:40% h:100% vertical](./assets/img/affordance__17.png)
![bg right:40% h:100% vertical](./assets/img/affordance__18.png)
![bg right:40% h:100% vertical](./assets/img/affordance__19.png)
![bg right:40% h:100% vertical](./assets/img/affordance__20.png)
...
<div style="position:relative;height:calc(300px + 5em);width:100%;overflow:hidden;"><iframe style="position:absolute;top:0;left:0;width:100%;height:100%;" src="https://makecode.microbit.org/---codeembed#pub:S63644-32563-56667-48169" allowfullscreen="allowfullscreen" frameborder="0" sandbox="allow-scripts allow-same-origin"></iframe></div>
...
![bg right:60% cover](./assets/img/bbc_soundeffects.png)
