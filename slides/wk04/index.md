...
# Sound, Space, and Body (SSB): <br>Week 4

---
# Set up your Sound Object DEMO.

## Make sure that everything works <br>the way it should!
...
- Split into Two Group of 5 each
    - <span style="color:hsl(313, 100.00%, 62.00%) ; font-weight: bold;">Group 1: Purple</span> 15mins
    - <span style="color:hsl(145, 100.00%, 50.00%); font-weight: bold;">Group 2: Green</span> 15mins
...
![bg right:40%](./assets/blackbird.png)
